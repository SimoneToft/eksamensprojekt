...
next_btn.onclick = ()=>{
    if(que_count < questions.length - 1){ //hvis question count (nuværende spørgsmål) er mindre en total questions
...
// henter spørgsmål og svarmuligheder fra array
...
function optionSelected(answer){
    ...
    let correcAns = questions[que_count].answer; //henter korrekt svar fra array
